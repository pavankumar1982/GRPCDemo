...
public final class HelloWorldServiceGrpc {
  ...
  public static final String SERVICE_NAME = "grpcdemo.test.generated.HelloWorldService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<grpcdemo.test.generated.Person,
      grpcdemo.test.generated.Greeting> getSayHelloMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "sayHello",
      requestType = grpcdemo.test.generated.Person.class,
      responseType = grpcdemo.test.generated.Greeting.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<grpcdemo.test.generated.Person,
      grpcdemo.test.generated.Greeting> getSayHelloMethod() {
    io.grpc.MethodDescriptor<grpcdemo.test.generated.Person, grpcdemo.test.generated.Greeting> getSayHelloMethod;
      ...
      synchronized (HelloWorldServiceGrpc.class) {
        if ((getSayHelloMethod = HelloWorldServiceGrpc.getSayHelloMethod) == null) {
          HelloWorldServiceGrpc.getSayHelloMethod = getSayHelloMethod = 
              io.grpc.MethodDescriptor.<grpcdemo.test.generated.Person, grpcdemo.test.generated.Greeting>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(
                  "grpcdemo.test.generated.HelloWorldService", "sayHello"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpcdemo.test.generated.Person.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  grpcdemo.test.generated.Greeting.getDefaultInstance()))
  ...
  public static abstract class HelloWorldServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void sayHello(grpcdemo.test.generated.Person request,
        io.grpc.stub.StreamObserver<grpcdemo.test.generated.Greeting> responseObserver) {
    ...
    @java.lang.Override public final io.grpc.ServerServiceDefinition bindService() {
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncUnaryCall(
              new MethodHandlers<
                grpcdemo.test.generated.Person,
                grpcdemo.test.generated.Greeting>(
  ...
  public static final class HelloWorldServiceBlockingStub extends io.grpc.stub.AbstractStub<HelloWorldServiceBlockingStub> {
    ...
    /**
     */
    public grpcdemo.test.generated.Greeting sayHello(grpcdemo.test.generated.Person request) {
  ...
  public static final class HelloWorldServiceFutureStub extends io.grpc.stub.AbstractStub<HelloWorldServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<grpcdemo.test.generated.Greeting> sayHello(
        grpcdemo.test.generated.Person request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SAY_HELLO:
          serviceImpl.sayHello((grpcdemo.test.generated.Person) request,
              (io.grpc.stub.StreamObserver<grpcdemo.test.generated.Greeting>) responseObserver);
          break;
        default:
  ...
  private static abstract class HelloWorldServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return grpcdemo.test.generated.Demo.getDescriptor();
    }
